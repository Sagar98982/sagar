...
void add()
{
    FILE  *f1;
    struct employee e1;
    f1=fopen("/home/sagar/Desktop/lorem/world7.txt","a");
 ...
 fwrite(&e1,sizeof(e1),1,f1);
    ...
    // printf("%d",e1.a1.house);
    // printf("%d",e1.a1.street);
    // printf("%d",e1.a1.pincode);
    // printf("%s",e1.a1.state);
    // printf("%s",e1.a1.country);
...
void display()
{
    FILE *f1;
    struct employee e1;
    f1=fopen("/home/sagar/Desktop/lorem/world7.txt","r");
